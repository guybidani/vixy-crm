        ...
        {value ? (
          <>
            ...
            <button
              ...
              className="opacity-0 group-hover:opacity-100 focus:opacity-100 p-0.5 text-[#9699A6] hover:text-[#E2445C] focus:text-[#E2445C] transition-all"
          ...
          <button
            ...
            className="text-[#9699A6] hover:text-[#0073EA] transition-colors"
